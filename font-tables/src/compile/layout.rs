mod builder {
    struct PairPos2Builder {
        class1: Offset16To<ClassDef>,
        class2: Offset16To<ClassDef>,
        records: Vec<Class1Record>,
    }
    ...
    //fn pair_pos_2(class1: ClassDef, class2: ClassDef, kj,)

}
mod owned {

    //NOTE: this is what we would *want* to generate for PairPosFormat2
    struct PairPos2 {
        class1: Offset16To<ClassDef>,
        class2: Offset16To<ClassDef>,
        records: Vec<Class1Record>,
